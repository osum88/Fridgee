import {
  archiveFoodInventoryService,
  changeRoleInventoryUserService,
...
export const changeRoleInventoryUser = async (req, res, next) => {
  try {
    ...
    const newUserRole = await changeRoleInventoryUserService(
      userId,
      inventoryId,
      targetUserId,
      newRole,
...
export const deleteOtherFoodInventoryUser = async (req, res, next) => {
  try {
    ...
    const deletedUser = await deleteOtherFoodInventoryUserService(
      removerId,
      inventoryId,
      targetUserId,
    );
...
export const changeSettingFoodInventoryUser = async (req, res, next) => {
  try {
    ...
    const inventoryDetails = await changeSettingFoodInventoryUserService(
      userId,
      inventoryId,
      settings,
      isAdmin,
...
export const getInventoryContent = async (req, res, next) => {
  try {
